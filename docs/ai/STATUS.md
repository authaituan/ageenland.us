...
| Mục | Giá trị |
|---|---|
| **Snapshot hiện tại** | `SNAP-004` — Đóng gói Tailwind v3 qua PostCSS, bỏ CDN · 2026-09-24 |
...
| 2 | ~~Chuyển Tailwind từ CDN sang đóng gói trong build~~ — xong 2026-09-24 | Antigravity · Gemini 3.6 Flash | ✅ |
...
- **Q1** (hoãn) Hosting thật — chỉ cần khi PO muốn deploy; hiện chỉ chạy local, không chặn việc #3.

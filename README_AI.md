...
Stack: React 19 + Vite · Tailwind qua CDN (`<script>` trong `index.html`, chưa đóng gói vào build) · Express 5 + SQLite · Node · Playwright (E2E). Repo: `authaituan/ageenland.us`, nhánh `main`.

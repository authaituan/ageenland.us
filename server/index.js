...
const PROJECTS = [
  ...
  {
    id: 3,
    title: 'Trồng Cây Bóng Mát & Cắt Tỉa Khu Resort Vinh',
    category: 'Resort',
    location: 'Nghệ An',
    area: '1,200 m²',
    beforeImage: '/images/tree_planting.png',
    afterImage: '/images/hero.png',
    description: 'Cung cấp 30 cây chà là & tùng bách lớn, cắt tỉa định hình hàng rào cây xanh dài 300m.'
  }
];
...
app.get('/api/stats', (req, res) => {
  db.get('SELECT COUNT(*) as totalQuotes FROM quotes', [], (err, row) => {
    ...
    res.json({
      success: true,
      data: {
        totalQuotes: totalQuotes + 128, // base offset for showcase
        satisfiedClients: '99%',
